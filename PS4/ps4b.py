...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(26):
            ...
            shift_to_real_words[26 - i] = counter
        
        
        # Finding best shift value in dictionary (maximum number of real words)
        best_shift_value = max(shift_to_real_words, key=shift_to_real_words.get)
        decrypted_message = self.apply_shift(best_shift_value)
        return (str(best_shift_value) + ", " + "'" + decrypted_message + "'")
        
        
            
            
#text = 'sqdd'
#caesar = CiphertextMessage(text)
#print(caesar.decrypt_message())
...
#
    ...
    #ciphertext = CiphertextMessage('sqdd')
    #print('Expected Output:', (1, 'tree'))
    #print('Actual Output:', ciphertext.decrypt_message())
